...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2025 at 12:20 PM
...
(197, 1, 1, 3, 1, 84, 600000.00, 1.0000, '600k', 'hoan_thanh', '2025-08-25 06:54:58', '2025-08-25 06:55:28'),
(198, 2, 3, 1, 1, 84, -600000.00, -1.0000, 'Nhận lịch: 600k', 'hoan_thanh', '2025-08-25 06:54:58', '2025-08-25 06:55:28'),
(199, 1, 1, 3, 1, 85, 200000.00, 1.0000, '200k', 'hoan_thanh', '2025-08-25 09:03:11', '2025-08-25 09:03:31'),
(200, 2, 3, 1, 1, 85, -200000.00, -1.0000, 'Nhận lịch: 200k', 'hoan_thanh', '2025-08-25 09:03:11', '2025-08-25 09:03:31');
...
(84, 3, 1, '2025-08-25 13:54:00', '2025-08-25 13:54:00', '2025-08-25 16:54:00', '2025-08-25 16:54:00', 1, 1, '2025-08-25 06:54:58', 'da_xac_nhan', 3),
(85, 3, 1, '2025-08-25 18:03:00', '2025-08-25 18:03:00', '2025-08-25 18:03:00', '2025-08-25 18:03:00', 1, 1, '2025-08-25 09:03:11', 'da_xac_nhan', 3);
...
(1, 'admin', '$2a$12$Mte75pD0aoir0x7kYMGs0uG1YGvjIrtC7gR4uCLhhq.RKTCSpYE4S', 'admin@company.com', 'Trần Quản Trị', '0987654321', NULL, 1800000.00, 12.0000, 1, '2025-08-20 08:32:05', '2025-08-25 09:03:31'),
...
(3, 'tranthiB', '$2a$12$dzWcobCrPlIA04tAEx.3m.WkjI3y56SoFL.L4CXgAYIJy6Y9/o7i.', 'tranthib@yahoo.com', 'Trần Thị B', '0923456789', NULL, 200000.00, 8.0000, 0, '2025-08-20 08:32:05', '2025-08-25 09:03:31'),
...
(187, 3, 197, 'Bạn có lịch xe mới từ admin - nhận 600.000 VNĐ và nhận 1 điểm (có lịch xe đi kèm)', 1, '2025-08-25 06:54:58'),
(188, 1, 197, 'Bạn đã giao lịch xe cho người dùng - nhận 600.000 VNĐ và nhận 1 điểm (có lịch xe đi kèm)', 1, '2025-08-25 06:54:58'),
(189, 1, 197, 'Lịch xe của bạn đã được xác nhận bởi tranthiB. Bạn đã nhận 600000.00 VNĐ và 1 điểm.', 1, '2025-08-25 06:55:28'),
(190, 3, 199, 'Bạn có lịch xe mới từ admin - nhận 200.000 VNĐ và nhận 1 điểm (có lịch xe đi kèm)', 1, '2025-08-25 09:03:12'),
(191, 1, 199, 'Bạn đã giao lịch xe cho người dùng - nhận 200.000 VNĐ và nhận 1 điểm (có lịch xe đi kèm)', 1, '2025-08-25 09:03:12'),
(192, 1, 199, 'Lịch xe của bạn đã được xác nhận bởi tranthiB. Bạn đã nhận 200000.00 VNĐ và 1 điểm.', 1, '2025-08-25 09:03:31');
...
--
ALTER TABLE `bao_cao`
  MODIFY `id_bao_cao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `giao_dich`
--
ALTER TABLE `giao_dich`
  MODIFY `id_giao_dich` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;

--
-- AUTO_INCREMENT for table `lich_xe`
--
ALTER TABLE `lich_xe`
  MODIFY `id_lich_xe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `thong_bao`
  MODIFY `id_thong_bao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;
